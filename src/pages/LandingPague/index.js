  ...
  return (
    <div className="home-page-container" ref={containerFather}>
      <div className='chat-pos'>
        ...
        <Button type='danger' onClick={displayChattingRoom} style={{fontSize: '2rem', position: 'absolution', right: '20px', backgroundColor: '#fe5621', height: '55px', width: '55px', borderRadius:'100%', padding: '0px',boxShadow: 'rgba(0, 0, 0, 0.25) 0px 14px 28px, rgba(0, 0, 0, 0.22) 0px 10px 10px', display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
          <WechatOutlined />
        </Button>
      </div>
